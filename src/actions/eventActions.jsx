...
export const getEvents = (token) => async (dispatch) => {
  try {
    const res = await axios.get('https://eventease-api.onrender.com/api/events', {
...
export const createEvent = (eventData, token) => async (dispatch) => {
  try {
    const res = await axios.post('https://eventease-api.onrender.com/api/events/create', eventData, {
      headers: { 'x-auth-token': token }
    });
...
export const updateEvent = (id, eventData, token) => async (dispatch) => {
  try {
    const res = await axios.put(`https://eventease-api.onrender.com/api/events/${id}`, eventData, {
      headers: { 'x-auth-token': token }
    });
...
export const deleteEvent = (id, token) => async (dispatch) => {
  try {
    await axios.delete(`https://eventease-api.onrender.com/api/events/${id}`, {
      headers: { 'x-auth-token': token }
    });
